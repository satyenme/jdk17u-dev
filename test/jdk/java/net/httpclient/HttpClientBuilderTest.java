...
public class HttpClientBuilderTest {
    ...
    public void testSSLParameters() {
        ...
        assertFalse(builder.build().sslParameters().getNeedClientAuth(),
                "needClientAuth() was expected to be false");
        assertFalse(builder.build().sslParameters().getWantClientAuth(),
        ...
        assertTrue(builder.build().sslParameters().getNeedClientAuth(),
        ...
        assertTrue(builder.build().sslParameters().getWantClientAuth(),
